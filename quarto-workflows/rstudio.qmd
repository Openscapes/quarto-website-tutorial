...
Here's an example showing the same file in the original Source Editor with content in markdown format and in the Visual Editor with content that looks more like it will appear in a live site. You can switch freely between them.

::: {layout-ncol="2"}
![RStudio IDE highlighting the Source Editor](images/rstudio-source-editor.png)

![RStudio IDE highlighting the Visual Editor](images/rstudio-visual-editor.png)
:::
